...
const seedOrders: Order[] = [
  {
    ...
    items: [{ productId: 'prod-2', productName: 'Monstera Deliciosa', price: 36, quantity: 1 }],
    total: 36,
    status: 'delivered',
  ...
  },
  {
    ...
    items: [{ productId: 'prod-3', productName: 'Lavender Oat Soap', price: 14, quantity: 3 }],
    total: 42,
    status: 'processing',
  ...
  },
  {
    ...
    items: [
      { productId: 'prod-6', productName: 'Eucalyptus Bundle', price: 18, quantity: 1 },
      { productId: 'prod-9', productName: 'Spring Gift Box', price: 55, quantity: 1 },
    ],
    total: 73,
    status: 'shipped',
...
export const getProductById = (id: string) => db.products.find((p) => p.id === id);
export const getProductBySlug = (slug: string) => db.products.find((p) => p.slug === slug);

export const getCategories = () => db.categories;
export const getCategoryById = (id: string) => db.categories.find((c) => c.id === id);
